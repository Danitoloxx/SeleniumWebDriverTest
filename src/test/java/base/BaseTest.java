...
public class BaseTest {
    ...
    public void setUp(){
        ...
        driver = new ChromeDriver(); // Instancia el web driver de la clase ChromeDriver
//        driver.get("https://the-internet.herokuapp.com/");
    ...
    public void recordFailures(ITestResult result){
        if(ITestResult.FAILURE == result.getStatus()){
            ...
            try {
                Files.move(screenshot, new File("E:\\Academy QC\\Selenium Web Driver\\resources\\Screenshots" + result.getName() + ".png"));
            }catch(IOException e){
                e.printStackTrace();
            }
        }
